...
export const get_request_path = 'http://localhost:8000/registration_requests/get_all';
export const approve_request_path = 'http://localhost:8000/registration_requests/status';
