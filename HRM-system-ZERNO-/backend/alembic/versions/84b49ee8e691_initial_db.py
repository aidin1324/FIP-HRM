...
Revision ID: 84b49ee8e691
Revises: 
Create Date: 2025-01-12 19:03:42.127436
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_waiter_scores_category_id'), 'waiter_scores', ['category_id'], unique=False)
    ...
    op.execute("INSERT INTO categories (category) VALUES ('положительный'), ('негативный'), ('нейтральный')")
    op.execute(
        """
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_waiter_scores_category_id'), table_name='waiter_scores')
