...
export { default as roadmap4 } from './roadmap/api.png';
...
export { default as benefitImage2 } from './benefits/logo-star.svg';
// Socials Section
...
// General Imports
export { default as logo } from './logo-star.svg';
export { default as csr } from './eco-csr.png';
export { default as dash1 } from './dashboard1.png';
...
export {default as desktop1} from './desktop1.png'
export {default as desktop2} from './desktop2.png'
export {default as phone_analytics} from './phone_analytics.png'
export {default as phone_waiters} from './phone_waiters.png'
export {default as feedback_intro} from './feedback_intro.png'
