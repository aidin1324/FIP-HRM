...
const pricing = [
    ...
    {
        title: "Subscription",
        description: "Страница обратной связи, Административная панель с аналитическими инструментами",
        price: "39",
        features: ["Уникальная страница обратной связи", "Техническая поддержка", "AI аналитика"],
    },
    {
        title: "Enterprise",
        description: "Персонализированное решение, выбор и заказ необходимой аналитики и функций",
        price: null,
        features: ["Все возможности подписки", "Интеграции с корпоративными системами", "Расширенная аналитика"],
    },
];
    ...
    return (
        <Section className="overflow-hidden" id="pricing">
            <div className="container relative z-2">
                ...
                <Heading tag="FIP Alcyone" title="Наши опции"/>

                <div className="relative">
                    <div className="flex gap-[1rem] max-lg:flex-wrap">
                        {pricing.map((item, i) => (
                            <div key={i} className="w-[19rem] max-lg:w-full h-full px-6 bg-n-8 border-purple-300 border border-n-6 rounded-[2rem] lg:w-auto even:py-14 odd:py-8 odd:my-4 [&>h4]:first:text-color-2 [&>h4]:even:text-color-1 [&>h4]:last:text-color-3">
                                ...
                                <Button className="w-full mb-6" href={item.price ? "/pricing" : "mailto:han_ai@gmail.com"} white={item.price}>
                                    {item.price ? "SOON" : "Contact us"}
                                </Button>
